...
namespace GildedRose.IntegrationTests
{
	...
	public class TextTests
	{
        ...
        public void TextTest()
        {
            ...
            var factory = new ItemUpdaterFactory(new Dictionary<ItemType, Func<Item, ItemUpdater>>
            {
            ...
            var gildedRose = new GildedRose(factory, inventory);
            var app = new Application(gildedRose, inventory);
