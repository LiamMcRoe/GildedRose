...
{
	/// <summary>
	/// Performs updates on an <see cref="Item"/> of type <see cref="ItemType.Brie"/>.
	/// </summary>
	public class BrieItemUpdater : ItemUpdater
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="BrieItemUpdater"/> class.
		/// </summary>
